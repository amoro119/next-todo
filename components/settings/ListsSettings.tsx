      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="新清单名称"
            className="flex-1 px-3 py-2 rounded-lg border border-[oklch(var(--border))] bg-[oklch(var(--background))] text-[oklch(var(--foreground))] text-sm focus:outline-none focus:ring-1 focus:ring-[oklch(var(--ring))]"
          />
          <button
            onClick={handleAdd}
              ...
              {editingList?.id === list.id ? (
                <>
                  <input
                    ...
                    className="flex-1 px-2 py-1 rounded border border-[oklch(var(--border))] bg-[oklch(var(--background))] text-[oklch(var(--foreground))] text-sm focus:outline-none focus:ring-1 focus:ring-[oklch(var(--ring))] mr-2"
                  />
